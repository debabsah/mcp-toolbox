...
| `core.MCPLatest` | **(Recommended)** Automatically uses the latest supported protocol version (currently `v2026-06-18`). |
| `core.MCPv20260618` | MCP Protocol version 2026-06-18. |
